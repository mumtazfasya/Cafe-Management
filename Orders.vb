...
Public Class Orders
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("***Your Bill Payment", New Font("Arial", 14), Brushes.BlueViolet, 350, 60)
        ...
        e.Graphics.DrawString("Thank You For Buying In Our Cafe. Please Come Back Soon!", New Font("Arial", 15), Brushes.Crimson, 130, 600)
